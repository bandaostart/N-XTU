...
QT_MOC_LITERAL(1, 13, 18), // "Signal_DialogClose"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 18), // "Signal_CancelClose"
QT_MOC_LITERAL(4, 52, 8), // "portname"
QT_MOC_LITERAL(5, 61, 17), // "Slot_Dialog_Close"
QT_MOC_LITERAL(6, 79, 19) // "Cancel_Button_Close"

    },
    "SearchDialog\0Signal_DialogClose\0\0"
    "Signal_CancelClose\0portname\0"
    "Slot_Dialog_Close\0Cancel_Button_Close"
};
...
void SearchDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Signal_DialogClose(); break;
        case 1: _t->Signal_CancelClose((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 2: _t->Slot_Dialog_Close(); break;
        case 3: _t->Cancel_Button_Close(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SearchDialog::Signal_DialogClose)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (SearchDialog::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SearchDialog::Signal_CancelClose)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void SearchDialog::Signal_DialogClose()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void SearchDialog::Signal_CancelClose(const QString & _t1)
{
